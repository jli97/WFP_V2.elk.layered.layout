...
public class LayeredOptions implements ILayoutMetaDataProvider {
  /**
   * The id of the ELK Layered for WF+ algorithm.
   */
   ...
   */
  public static final IProperty<Double> SPACING_LABEL_PORT = CoreOptions.SPACING_LABEL_PORT;
  ...
  /**
   * Default value for {@link #PRIORITY} with algorithm "ELK Layered for WF+".
   */
  ...
  /**
   * Default value for {@link #PADDING} with algorithm "ELK Layered for WF+".
   */
  ...
  /**
   * Default value for {@link #EDGE_ROUTING} with algorithm "ELK Layered for WF+".
   */
  ...
  /**
   * Default value for {@link #PORT_BORDER_OFFSET} with algorithm "ELK Layered for WF+".
   */
  ...
  /**
   * Default value for {@link #RANDOM_SEED} with algorithm "ELK Layered for WF+".
   */
  ...
  /**
   * Default value for {@link #ASPECT_RATIO} with algorithm "ELK Layered for WF+".
   */
  ...
  /**
   * Default value for {@link #SEPARATE_CONNECTED_COMPONENTS} with algorithm "ELK Layered for WF+".
   */
  ...
  /**
   * Default value for {@link #DIRECTION} with algorithm "ELK Layered for WF+".
   */
  ...
  /**
   * Default value for {@link #PORT_ALIGNMENT_DEFAULT} with algorithm "ELK Layered for WF+".
   */
  ...
  public void apply(final org.eclipse.elk.core.data.ILayoutMetaDataProvider.Registry registry) {
    registry.register(new LayoutAlgorithmData.Builder()
        ...
        .melkBundleName(null)
        .definingBundleId("WFP_V2.elk.layered.layout")
